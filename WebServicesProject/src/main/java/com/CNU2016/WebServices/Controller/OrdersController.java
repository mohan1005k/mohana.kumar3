...
public class OrdersController {
    ...
    @RequestMapping(value="/ordersuser/{Id}",method = RequestMethod.GET)
    public User getOrdersUser(@PathVariable Integer Id)
    {
        User user1=ordersRepository.findOne(Id).getUser_for_order();
    ...
    @Transactional
    @RequestMapping(value="/api/{Id}/orderlineitem",method=RequestMethod.POST)
