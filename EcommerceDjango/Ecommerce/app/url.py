...
router.register(r'categories', viewsets.CategoriesViewSet,base_name='CategoriesViewSet')
router.register(r'users',viewsets.UserViewSet,base_name='UserViewSet')
router.register(r'feedback',viewsets.FeedbackViewSet,base_name='FeedbackViewSet')
router.register(r'health',viewsets.HealthViewSet,base_name='HealthViewSet')
